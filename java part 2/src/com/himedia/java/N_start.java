    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (myChoice) {
                ...
                case 5:
                    // getMoney
                    int gtMoney = vendingMachine.getTotalMoney();
                    int gMoney = vendingMachine.getMoney();
                    vendingMachine.setTotalMoney(gtMoney + gMoney);
                    break;
                case 6:
                    System.out.printf("잔돈 : %d 원이 반환되었습니다.", vendingMachine.getTotalMoney());
                    return;
                default:
